...
<div className=' sm:rounded-2xl container mx-auto flex flex-wrap flex-col '>
...
<Link href='/about'>
<div className='hidden sm:block'><a className='mx-1 hover:text-qorange cursor-pointer uppercase'>About</a></div>
</Link>
